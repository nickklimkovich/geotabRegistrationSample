...
(function () {
   ...
   * @returns {string}
   */
  getEndpoint = function getEndpoint(host) {
   ...
   */
  post = function post(server, method, params) {
   ...
   *  @return {Object} - a promise that will supply the results
   */
  jsonp = function jsonp(server, method, params) {
    return new Promise(function (resolve, reject) {
      var uid = 'json' + (Math.random() * 100).toString().replace(/\./g, '');
      var buildParamString = function buildParamString() {
        var query = [];
   ...
   *  @return {Promise}
   */
  multiCall = function multiCall(server, calls, credentials) {
...
//# sourceMappingURL=geotab.js.map
